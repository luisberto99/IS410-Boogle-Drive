<?php
	...
	function btn_superiores($icon){
		echo '<button class="transpariencia btn_lateral dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" type="button"><span class="'.$icon.'" aria-hidden="true"></span></button>';
	}
?>
<!DOCTYPE html>
<html>
	...
	<div id="General" class="barra_superior">
		...
		<div class="row">
			...
			<div class="col-md-2 dere">
				<button class="transpariencia btn_lateral"><span class="glyphicon glyphicon-list" aria-hiddent=true></span></button>
				<button class="transpariencia btn_lateral"><span class="glyphicon glyphicon-info-sign" aria-hiddet="true"></span></button>
